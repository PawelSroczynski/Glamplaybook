...
### Source Documents
- **SOP_INFRASTRUCTURE.md** → 53 SOPs, 24 Quality Gates (operational backbone)
- **Enklava Whitepaper** → Ecosystem vision, tokenomics, regenerative settlement
- **Marketing Strategy** → 3 avatars, SLO funnel, lead magnet positioning

### Book Purpose (Triple Function)
...
│     └─ Entry point to funnel, positions authority                       │
│                                                                         │
│  2. PRODUCT (Full book - digital + physical)                            │
│     └─ Standalone value, presale to community                           │
│                                                                         │
│  3. MANUAL LITE (Accessible version of SOPs)                            │
│     └─ Human-friendly intro → upsell to Manual 12k (full SOPs)          │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
| Avatar | Profile | Primary Interest | Book Focus |
|--------|---------|------------------|------------|
| **A** | Investor / Glamping Operator | ROI, legal, turnkey | Parts I, II, IX, X |
| **B** | DIY Builder (resourced) | KIT assembly, practical | Parts III-VIII |
| **C** | Engineer / Deep DIY | Full technical detail | All + Manual 12k upsell |
...
**Quality Gate Coverage:** QG-PROD-B1, QG-PROD-B2, QG-PROD-B3
...
**Quality Gate Coverage:** QG-PROD-C1, QG-PROD-4
...
│                                                                         │
│  ┌─────────────┐   ┌─────────────┐   ┌─────────────┐   ┌─────────────┐  │
│  │   BLOG      │   │   PODCAST   │   │   YOUTUBE   │   │   COURSE    │  │
│  │   POST      │   │   EPISODE   │   │   VIDEO     │   │   MODULE    │  │
│  └─────────────┘   └─────────────┘   └─────────────┘   └─────────────┘  │
│        │                 │                 │                 │          │
│        ▼                 ▼                 ▼                 ▼          │
│  ┌─────────────────────────────────────────────────────────────────┐   │
│  │                     CONTENT ASSETS                               │   │
│  │  • Photos (site, process, finished)                             │   │
│  │  • CAD renders (3D visualizations)                              │   │
│  │  • Data sheets (specs, calculations)                            │   │
│  │  • Checklists (printable)                                       │   │
│  │  • Interview clips (community contributors)                     │   │
│  └─────────────────────────────────────────────────────────────────┘   │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
| Format | Length | Cadence | Platform | Purpose |
|--------|--------|---------|----------|---------|
| **Blog** | 1500-3000 words | Bi-weekly | enklava.pl / toloka.site | SEO, authority, gated content |
| **Podcast** | 20-45 min | Bi-weekly | Spotify, Apple, YouTube | Depth, interviews, community |
| **YouTube** | 8-20 min | Bi-weekly | YouTube, embedded | Visual demo, tutorials |
| **Course** | 15-30 min per module | Drip | EnklavaLab (LMS) | Structured learning, paid |
...
| Category | Role | Content Contribution |
|----------|------|---------------------|
| **Technical** | | |
| Architects | Design validation | CAD review, design principles |
| Structural engineers | Safety verification | Load calculations, foundation specs |
| HVAC specialists | Systems design | Heating, ventilation chapters |
| Solar/electrical experts | Off-grid systems | Electrical and solar chapters |
| Carpenters/woodworkers | Production expertise | Wood production chapters |
| Sewers/upholsterers | Cover production | Sewing chapters |
| **Legal/Business** | | |
| Building lawyers | Legal compliance | Legal chapter review |
| Insurance brokers | Risk assessment | Insurance chapter |
| Financial analysts | ROI validation | Business model chapter |
| Tourism consultants | Hospitality | Operations chapter |
| **Living Experience** | | |
| Year-round yurt dwellers | Real-world testing | Case studies, troubleshooting |
| Off-grid practitioners | Systems integration | Systems chapters |
| Permaculture designers | Site integration | Site selection chapter |
| **Cultural** | | |
| Mongolian yurt builders | Traditional techniques | History, anatomy chapters |
| Central Asian craftspeople | Authentic methods | Production insights |
| Anthropologists | Cultural context | Vision chapter |
| **Validation** | | |
| Beta readers | Content testing | All chapters - readability |
| DIY builders (pilot) | Real-world testing | Assembly, production validation |
| Franchise pilots | Business validation | Scaling chapter |

### Contribution Mechanisms

| Method | Effort | Recognition |
|--------|--------|-------------|
| Interview (podcast/video) | Low | Named credit, audience exposure |
| Chapter review | Medium | Acknowledgment, early access |
| Co-authorship | High | Named contributor, revenue share |
| Photo/video contribution | Low-Medium | Credit, portfolio link |
...
### Phase 1: SEED (Jan 2025)
**Goal:** Foundation content, email list started
...
**Goal:** Bi-weekly drip, OTO funnel live, community forming
...
- Complete digital version available to list
- Physical book presale campaign
- Community contributor acknowledgments finalized
- Print production

### Phase 5: LAUNCH (Nov 2025)
**Goal:** Physical book ships, full product ecosystem

- Physical book delivery
- Complete EnklavaLab course modules
- Manual 12k (full SOPs) available as upsell
- Franchise pilot integration

---

## Content Production Pipeline

### Monthly Rhythm (Bi-weekly release)

```
Week 1: RESEARCH & OUTLINE
├── Review relevant SOPs
├── Community contributor interviews
├── Photo/CAD asset gathering
└── Outline approval
...
### Asset Requirements Per Chapter

| Asset Type | Source | Quantity | Notes |
|------------|--------|----------|-------|
| Photos | Site visits, production | 10-20 per chapter | High resolution |
| CAD renders | 3D modeling | 3-5 per technical chapter | Exploded views |
...
**Manual 12k = Full SOP Package (53 SOPs + 24 QGs + Checklists + Video)**

Includes:
- All SOP documents in professional format
- Video walkthrough per SOP
- Printable checklists
- CAD files (production-ready)
- Quality Gate decision trees
- Exception handling playbooks
- Updates for 12 months

**Target:** Avatar C (Engineers) + Franchise Buyers (DIY Pilot PoC)
